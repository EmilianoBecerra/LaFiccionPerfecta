...
const Breadcrumbs = ({ movieId }) => {
  ...
  return (
    <>
      {
        (movieName === null && location.pathname !== "/") || (location.pathname.includes("tema") && !selectedTopic.titulo) ? <Skeleton variant={"rectangular"} sx={{ bgcolor: "white" }} /> :
